...
plot(theta,dbeta(theta,a,b),type="l",ylim=c(0,1000))
...
ej3a.sim<-bugs(data,inits,parameters,model.file="Ej3a.txt",
               n.iter=50000,n.chains=2,n.burnin=500,n.thin=5)
...
#DIC
out.dic<-ej5d.sim$DIC
out.dic<-ej5c.sim$BUGSoutput$DIC
print(out.dic)
...
#DIC
out.dic<-ej6c.sim$DIC
#out.dic<-ej6c.sim$BUGSoutput$DIC
print(out.dic)
...
data<-list("n"=n,"y"=c(mercado$SHARE[1:(n-4)],NA,NA,NA,NA))

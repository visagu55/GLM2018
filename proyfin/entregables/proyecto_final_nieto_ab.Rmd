...
Los datos utilizados fueron obtenidos de un Banco  donde a partir de una muestra de 64mil clientes que representan de forma relevante el comportamiento general, con un histórico de de 24 meses agosto2016 a agosto2018 donde se resumen las contrataciones de créditos personales de forma mensual a lo largo de este periodo.
Es importante mencionar que los datos fueron un poco modificados a petición de la institución para poder compartirlos, pero no modifica la esencia del problema y la solución.

Notas de clase en particular el capítulo 5 que habla de modelos dinámicos ya que nuestro problema tiene que ver con temas temporales


Bayesian Data Analysis de Andrew  Gelman, A., Carlin, J. B., Stern, H. S. & Rubin, D. (2002). Bayesian Data Analysis, 2a. edición. Chapman & Hall: Boca Raton. 
